        ...
        <>
            <div className="min-h-screen bg-white"> 
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8">
                    ...
                    {/* Header */}
                    <div className="mb-6">
                        <h1 className="text-4xl font-bold text-gray-900 mb-2 capitalize">North India</h1>
                        <p className="text-gray-600 text-lg">Satisfy your cravings for North Indian breakfast with these crispy & buttery</p>
                    </div>
