  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-gray-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gray-900">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1617458315152-7e77a1c7c25a?auto=format&fit=crop&q=80')] bg-cover bg-center"></div>
        ...
        <div className="relative w-full flex flex-col justify-end p-12 lg:p-16 text-white z-10">
          ...
          <h1 className="text-4xl lg:text-5xl font-bold tracking-tight mb-4">
            Welcome back to <span className="text-blue-400">Foodcut</span>
          </h1>
          <p className="text-lg text-gray-300 max-w-md">
            Sign in to access your dashboard, track your earnings, and manage your deliveries seamlessly.
          </p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-8 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Sign in to continue to your dashboard</p>
          </div>
