...
export default function MyDashBoard() {
  ...
  return (
    <div className="flex h-screen bg-gray-50 text-gray-800 font-sans w-full">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-gray-100 flex flex-col justify-between shrink-0">
        <div className="py-6 px-0">
          <nav className="space-y-2 mt-4 pr-6">
            ...
            <NavItem icon={<LineChart size={20} />} label="job" active={activeTab === "job porcol"} onClick={() => setActiveTab("job")} />
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        ...
        <MenuItemCard 
          ...
          price="99"
          title="kijijuin"
          description="ljkhghubbhgfgdresesercgfhvhjgyggt7trtrty67t676tt tyy7 t"
          inStock={true}
        />
        {/* Menu Item 2 */}
        <MenuItemCard 
          ...
          type="Non-Veg"
          price="91"
          title="piyushkumar909"
          description="scriptsss-onDireve"
          inStock={true}
        />
      </div>
    </div>
...
function MenuItemCard({ image, type, price, title, description, inStock }: any) {
