  ...
  parsePathRef($ref) {
    ...
    if (match) {
      ...
      if (pathSegment && method) {
        return { path: _chunkLD4LGZBBcjs.decodePointer.call(void 0, pathSegment), method };
      }
    }
    return null;
  }
  ...
  parseWebhookRef($ref) {
    ...
    if (match) {
      ...
      if (webhookName && method) {
        return { name: _chunkLD4LGZBBcjs.decodePointer.call(void 0, webhookName), method };
      }
    }
    return null;
  }
  ...
  walkPaths() {
    ...
    Object.keys(this.definition.paths).forEach((path) => {
      ...
      Object.keys(_optionalChain([this, 'access', _23 => _23.definition, 'access', _24 => _24.paths, 'optionalAccess', _25 => _25[path]]) || {}).forEach((method) => {
        if (method === "parameters" || !_chunkLD4LGZBBcjs.supportedMethods.includes(method.toLowerCase())) {
          return;
        }
        if (this.hasPathsToReduceBy) {
  ...
  reducePaths() {
    ...
    Object.keys(this.definition.paths).forEach((path) => {
      ...
      Object.keys(_optionalChain([this, 'access', _39 => _39.definition, 'access', _40 => _40.paths, 'optionalAccess', _41 => _41[path]]) || {}).forEach((method) => {
        const methodLC = method.toLowerCase();
        if (method === "parameters" || !_chunkLD4LGZBBcjs.supportedMethods.includes(methodLC)) {
          return;
        }
      ...
      Object.keys(webhook).forEach((method) => {
        ...
        if (this.hasWebhooksToReduceBy && !retainedByRef) {
          ...
          if (methodFilter !== "*" && Array.isArray(methodFilter) && !methodFilter.includes(methodLC)) {
            if (!_optionalChain([definition, 'access', _73 => _73.webhooks, 'optionalAccess', _74 => _74[webhookName]]) || _chunk7PWF3F2Wcjs.isRef.call(void 0, _optionalChain([definition, 'access', _75 => _75.webhooks, 'optionalAccess', _76 => _76[webhookName]]))) {
              return;
            }
