 ...
 *
 */
declare const isSwagger: (schema: any) => schema is OpenAPIV2.Document;
/**
 * Is a given object an OpenAPI 3.0 API definition?
 *
 */
declare const isOpenAPI30: (schema: any) => schema is OpenAPIV3.Document;
/**
 * Is a given object an OpenAPI 3.1 API definition?
 *
 */
declare const isOpenAPI31: (schema: any) => schema is OpenAPIV3_1.Document;
/**
...
type SecuritySchemeDefaultAuthPrimitive = number | string;
interface BasicAuthDefault {
    pass?: SecuritySchemeDefaultAuthPrimitive;
    user?: SecuritySchemeDefaultAuthPrimitive;
}
interface OAuthClientCredentialsDefault {
...
type SecuritySchemeDefaultAuth = SecuritySchemeDefaultAuthPrimitive | BasicAuthDefault | OAuthClientCredentialsDefault;
interface User {
    [key: string]: unknown;
    keys?: {
        [key: string]: unknown;
 ...
 */
type ReferenceObject = OpenAPIV3_1.ReferenceObject | OpenAPIV3.ReferenceObject;
/**
