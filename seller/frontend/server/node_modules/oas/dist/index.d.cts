...
declare class Oas {
    ...
    splitUrl(selected?: number): SplitUrlResult;
    /**
     ...
     */
    private findRootServerOperationMatches;
    /**
     ...
     */
    private findOverriddenServerOperationMatches;
    /**
...
declare class Operation {
     ...
     */
    getRequestBody(mediaType?: string): false | {
        mediaType: string;
 ...
 * }
 */
declare const STATUS_URL = "status-url";
...
// @ts-ignore
export = Oas;
export { Callback as C, DISABLE_TAG_SORTING as D, EXPLORER_ENABLED as E, HEADERS as H, INTERNAL as I, METRICS_ENABLED as M, Operation as O, PARAMETER_ORDERING as P, SAMPLES_LANGUAGES as S, Webhook as W, CODE_SAMPLES as a, type Extensions as b, OAUTH_OPTIONS as c, PROXY_ENABLED as d, SIMPLE_MODE as e, STATUS_URL as f, extensionDefaults as g, getExtension as h, hasRootExtension as i, validateParameterOrdering as v };
