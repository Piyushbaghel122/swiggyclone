...
var _chunkTUF2HPKMcjs = require('./chunk-TUF2HPKM.cjs');
...
var APICore = (_class = class {
  ...
  constructor(definition, userAgent) {;_class.prototype.__init.call(this);_class.prototype.__init2.call(this);_class.prototype.__init3.call(this);
    if (definition) this.spec = _oas2.default.init(definition);
  ...
  async fetchOperation(operation, body, metadata) {
    return _chunkTUF2HPKMcjs.prepareParams.call(void 0, operation, body, metadata).then((params) => {
      const data = { ...params };
      if (this.server) {
        const preparedServer = _chunkTUF2HPKMcjs.prepareServer.call(void 0, this.spec, this.server.url, this.server.variables);
        if (preparedServer) {
          data.server = preparedServer;
        }
      }
      const har = this.getHARForRequest(operation, data, _chunkTUF2HPKMcjs.prepareAuth.call(void 0, this.auth, operation));
      let timeoutSignal;
      ...
      return _fetchhar2.default.call(void 0, har, { files: data.files || {}, init, userAgent: this.userAgent }).then(async (res) => {
        const parsed = await _chunkTUF2HPKMcjs.parseResponse.call(void 0, res);
...
exports.FetchError = _chunkNVFSP2R3cjs.FetchError; exports.default = APICore;
